      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-slate-300/90">
            King AI provides the foresight and intelligence to navigate the next frontier of DeFi. Undercollateralized lending and M1 pulldown mechanisms unlock capital efficiency and sovereign liquidity flows — the true next degree of finance. Powered by <a href="https://abraxas.vercel.app/" target="_blank" rel="noopener noreferrer" className="font-semibold text-orange-300 hover:text-orange-200 transition">Abraxas Protocol</a> institutional infrastructure.
          </p>
        </div>
